      ...
      <div className="detail-25">
             ...
             <div className="detail-desc-25">
              <div className="about-25">
                <h4>About Company</h4>
                <p>                <p>YouTube is a global video-sharing platform where users can upload, view, and share videos, ranging from entertainment and music to educational content and personal vlogs.</p>
                </p>
